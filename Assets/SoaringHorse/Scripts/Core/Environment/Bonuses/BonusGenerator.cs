...
public class BonusGenerator : BaseEnvironmentGenerator<Bonus>
{
    ...
    private void Construct(EnvironmentConfig envConfig, BonusConfig bonusConfig, Bonus.Factory bonusFactory)
    {
        ...
        InitSpawnParams(
            bonusConfig.MinBonusY,      // minY дл€ бонусов
            bonusConfig.MaxBonusY,      // maxY дл€ бонусов
            0f,                        // _fixedZ (2D)
            bonusConfig.BonusSpacing   // шаг по X дл€ бонусов (чтобы не спавнить слишком часто)
        );
    }
